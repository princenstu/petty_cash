    ...
    <div class="box span12">
        ...
        <div class="box-content">
            ...
            <form enctype="multipart/form-data" id="addproduct" class="form-horizontal" action="" method="post">
                ...
                <input type="hidden" name="id" value="<?php echo $affiliates['id'] ?>"/>
                <fieldset style="border: 1px solid #CCCCCC; margin:0 15px 5px 0">
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <input type="text" id="name"  name="name" value="<?php echo $affiliates['name'] ?>" class="input-xxlarge">
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <input type="text" id="email" name="email" value="<?php echo $affiliates['email'] ?>" class="input-xxlarge">
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <input type="text" id="phone" name="phone" value="<?php echo $affiliates['phone'] ?>" class="input-xxlarge">
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <textarea rows="10" cols="3" id="details" name="details"
                                      placeholder="Write something" class="input-xxlarge"><?php echo $affiliates['details']?></textarea>
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <input type="text" id="Percentage" name="percentage" value="<?php echo $affiliates['percentage'] ?>">
