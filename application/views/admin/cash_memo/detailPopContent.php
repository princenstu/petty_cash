<div>
    <ul class="breadcrumb">
        ...
        <li>
            <a href="/admin/orders">Cashmemo</a>
        </li>
    </ul>
</div>
    ...
    <div class="box span12">
        ...
        <div class="box-content">
            <table class="table table-bordered table-striped table-condensed">
                ...
                <tr>
                    <td>Memo No</td>
                    <td><?php echo  $cashmemoes->memo_no ?></td>
                </tr>
                <tr>
                    <td>Company Name</td>
                    <td><?php echo  $cashmemoes->name ?></td>
                </tr>
                <tr>
                    <td>Project Name</td>
                    <td><?php echo  $cashmemoes->project_name ?></td>
                </tr>
                <tr>
                    <td>Disbursed By</td>
                    <td><?php echo  $cashmemoes->disbursed_by?></td>
                </tr>
                <tr>
                    <td>Received By</td>
                    <td><?php echo  $cashmemoes->username ?></td>
                </tr>
                <tr>
                    <td>Amount</td>
                    <td><?php echo  $cashmemoes->amount ?></td>
                </tr>
                <tr>
                    <td>Amount in words</td>
                    <td><?php echo  $cashmemoes->amount_in_words ?></td>
                </tr>
                <tr>
                    <td>Purpose</td>
                    <td><?php echo  $cashmemoes->purpose ?></td>
                </tr>
                <tr>
                    <td>Create Date</td>
                    <td><?php echo  $cashmemoes->create_date; ?></td>
                </tr>
                <tr>

                    <td><a class="btn btn-success" href="/admin/archives/archivesInfo/<?php echo  $cashmemoes->memo_id ?>" onclick="return confirm('Are You Sure You Want To Detail information of The Cash Memo?')">
                        <i class="icon-trash icon-white"></i>
                        Achives
                    </a>
                        <a href="/admin/dashboard" class="btn">Cancel</a></td>
                </tr>
